...
var (
	modTemplate = `module github.com/{{.Application}}
`
...
gopackage:
	mkdir -p bin && go build -a -o bin/{{.Application}} main.go
...
// Application extends gogo.AppServer with customization
...
func (app *Application) Resources() {
	...
	app.GET("/@greeting/hello", GettingStart.Hello)
}
